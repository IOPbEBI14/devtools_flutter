...
import 'package:my_network_view/models/feature_toggle.dart';
...
class ListviewLayout extends HookConsumerWidget {
  ...
  final int tabIndex;
  final storage = networkIsOn ? FirebaseStorage.instance : null;

  ListviewLayout({Key? key, required this.hotelInfo, required this.tabIndex})
      : super(key: key);
